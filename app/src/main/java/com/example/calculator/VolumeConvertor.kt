...
class VolumeConvertor : AppCompatActivity() {
    ...
    val arr = arrayOf("liter","cubic meter","cubic centimeter","cubic Milimeter")
    val arr2 = arrayOf("liter","cubic meter","cubic centimeter","cubic Milimeter")
...
//            }
        ...
        bequal.setOnClickListener {
            if(arr[i]=="liter" && arr2[j]=="liter"){
                textView2.text = "${textView.text}"
            }
            if(arr[i]=="cubic meter" && arr2[j]=="cubic meter"){
                textView2.text = "${textView.text}"
            }

            if(arr[i]=="cubic centimeter" && arr2[j]=="cubic centimeter"){
                textView2.text = "${textView.text}"
            }
            if(arr[i]=="cubic Milimeter" && arr2[j]=="cubic Milimeter"){
                textView2.text = "${textView.text}"
            }
            if(arr[i]=="liter" && arr2[j]=="cubic meter"){
                textView2.text = "${(num/1000)}"
            }
            if(arr[i]=="liter" && arr2[j]=="cubic centimeter"){
                textView2.text = "${(num*1000)}"
            }
            if(arr[i]=="liter" && arr2[j]=="cubic Milimeter"){
                textView2.text = "${(num*1000000)}"
            }
            if(arr[i]=="cubic meter" && arr2[j]=="liter"){
                textView2.text = "${(num*1000)}"
            }
            if(arr[i]=="cubic meter" && arr2[j]=="cubic centimeter"){
                textView2.text = "${(num*1000000)}"
            }
            if(arr[i]=="cubic meter" && arr2[j]=="cubic Milimeter"){
                textView2.text = "${(num*1000000000)}"
            }
            if(arr[i]=="cubic centimeter" && arr2[j]=="liter"){
                textView2.text = "${(num/1000)}"
            }
            if(arr[i]=="cubic centimeter" && arr2[j]=="cubic meter"){
                textView2.text = "${(num/1000000)}"
            }
            if(arr[i]=="cubic centimeter" && arr2[j]=="cubic Milimeter"){
                textView2.text = "${(num*1000)}"
            }
            if(arr[i]=="cubic Milimeter" && arr2[j]=="liter"){
                textView2.text = "${(num/1000000)}"
            }
            if(arr[i]=="cubic Milimeter" && arr2[j]=="cubic meter"){
                textView2.text = "${(num/1000000000)}"
            }
            if(arr[i]=="cubic Milimeter" && arr2[j]=="cubic centimeter"){
                textView2.text = "${(num/1000)}"
            }
